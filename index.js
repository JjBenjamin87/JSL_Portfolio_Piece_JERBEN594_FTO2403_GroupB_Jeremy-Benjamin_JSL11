...
// call initializeData function 
initializeData();

// TASK: Get elements from the DOM
const elements = {

  // The DOM elements for the Navigation Sidebar
...
// Initialize activeBoard Variable
let activeBoard = "";
...
function filterAndDisplayTasksByBoard(boardName) {
  ...
  elements.columnDivs.forEach(column => {
    ...
    tasksContainer.className = 'tasks-container'; // Added class name here
...
function addTask(event) {
  ...
  // location.reload(); // Commented out to prevent unnecessary page refresh
}
